...
const buildInfo = {
	...
	sha:
		process.env.WORKERS_CI_COMMIT_SHA || process.env.GITHUB_SHA || localSha(),
	repository: getRepo(),
};
...
const result = spawnSync(
	...
	[
		...
		"--define",
		define("__AITSYS_GO_BUILD_VERSION__", buildInfo.version),
		"--define",
		define("__AITSYS_GO_BUILD_SHA__", buildInfo.sha),
		"--define",
		define("__AITSYS_GO_BUILD_REPOSITORY__", buildInfo.repository),
	],
	{ stdio: "inherit" },
);
