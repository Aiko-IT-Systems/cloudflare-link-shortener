...
const commands = [
	{
		...
		integration_types: [1],
		contexts: [2],
		options: [{ name: "url", description: "HTTPS URL to shorten", type: 3, required: true }]
	},
	{ name: "Shorten link", type: 3, integration_types: [1], contexts: [2] },
	{ name: "manage", description: "Manage your Discord-created short links", type: 1, integration_types: [1], contexts: [2] }
];

const response = await fetch(`https://discord.com/api/v10/applications/${applicationId}/commands`, {
	method: "PUT",
	headers: { Authorization: `Bot ${token}`, "Content-Type": "application/json", "User-Agent": "AITSYS-Go/1.3 (+https://go.aitsys.dev/)" },
