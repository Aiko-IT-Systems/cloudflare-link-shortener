...
if (!commandName) throw new Error("Usage: node scripts/run-worker.mjs <wrangler-command> [...args]");
...
if (commandName === "types") commandArgs.push("--config", "wrangler.generated.jsonc");
