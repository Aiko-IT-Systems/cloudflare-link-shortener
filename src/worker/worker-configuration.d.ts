/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.generated.jsonc --strict-vars=false` (hash: 8ddf1679647ac9135ad019f0a341a4e2)
...
interface __BaseEnv_Env {
	...
	LINK_SHORTENER_API_KEY: string;
	DISCORD_PUBLIC_KEY: string;
	LINK_PASSWORD_PEPPER: string;
	LINK_COORDINATOR: DurableObjectNamespace<import("./src/index").LinkCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LinkCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_NAME" | "BRAND_LOGO_URL" | "BRAND_LOGO_ALT" | "FAVICON_URL" | "BRAND_COLOR" | "PRIVACY_EMAIL" | "DISCORD_APPLICATION_ID" | "DISCORD_ADMIN_USER_ID" | "LINK_SHORTENER_API_KEY" | "DISCORD_PUBLIC_KEY" | "LINK_PASSWORD_PEPPER">> {}
}
